...
public class ChartDAO {
    public static ArrayList<Chart> getChartsInfo(String userId) throws SQLException {
        ...
        if (resultSet.next()) {
            SQLQuery = "SELECT TB_POSTAGEM.LINGUAGEM_POSTAGEM, TB_MATERIA.NOME_MATERIA,"
